...
img.src = '/paint.jpg';
img.onload = () => {
	  context2!.drawImage(img, 0, 0, img.width, img.height, 0, 0, VIEW_SIZE, VIEW_SIZE);
}
...
const update = () => {
	...
	const op = context2.globalCompositeOperation

	context3.globalCompositeOperation = "destination-out";
	context3.drawImage(canvas, 0, 0)
	context3.globalCompositeOperation = op
