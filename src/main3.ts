...
import {Texture, Vector2, Vector3, WebGLRenderTarget, PerspectiveCamera, WebGLRenderer, Scene,
...
class Sand{
    ...
    private channel1Texture: Texture
    private channel2Texture: Texture
    private poolTexture:Texture
    
    // two render textures
    private renderTexture1: WebGLRenderTarget
    private renderTexture2: WebGLRenderTarget
